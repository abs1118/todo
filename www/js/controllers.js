var ccc=angular.module('todo.io.controllers', []);
ccc.controller('TutorialCtrl', function($scope, $state, $ionicViewService) {
...
// 菜单
// *******************
ccc.controller('AppCtrl', function($scope, $state, MenuService) {
...
//  $stateParams.groupId
// *******************
ccc.controller('TodolistsCtrl', function($scope, $state, $stateParams, $timeout, 
...
//  $stateParams.groupId
// *******************
ccc.controller('TodolistsEditCtrl', function($scope, $state, $stateParams, $timeout, 
        $ionicGesture, $ionicActionSheet, $ionicNavBarDelegate, 
        MenuService, TodoListService) {
...
// 搜索页面
// *******************
ccc.controller('SearchCtrl', function($scope, $stateParams, TodoListService) {
  $scope.searchKey = "";
...
//  $stateParams.todoId
// *******************
ccc.controller('TodoCtrl', function($scope, $state, $stateParams, $ionicActionSheet, $ionicActionSheet) {
  // 任务ID（非空编辑，空的话新建）
...
// 添加列表页面
// *******************
ccc.controller('GroupCtrl', function($scope, $stateParams) {
})

// *******************
// 列表一览页面
// *******************
ccc.controller('GrouplistCtrl', function($scope, $state, MenuService) {
...
// 设置页面
// *******************
ccc.controller('SettingsCtrl', function($scope, $state, $stateParams) {

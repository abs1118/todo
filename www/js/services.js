var fff=angular.module('todo.io.services', []);
fff.provider('dummyData', function() {
    var menus = [
...
fff.factory('MenuService', function ($q, dummyData) {
  return {
...
fff.factory('TodoListService', function ($q, dummyData) {
    return {
